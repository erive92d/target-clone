...
export default function Main() {
  return (
    <nav className="navbar lg:gap-10  flex-wrap lg:flex-nowrap md:flex-nowrap lg:px-14">
      {/* Mobile Displays */}
      ...
      {/* User */}
      <div className="navbar-end gap-2 font-light text-sm w-1/3 lg:w-96 ">
        <Link href="/profile" className="lg:flex items-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 16 16"
            fill="currentColor"
